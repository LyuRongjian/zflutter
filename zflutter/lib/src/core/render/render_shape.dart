...
class RenderZShape extends RenderZBox {
  ...
  void performSort() {
    ...
    var firstPoint = transformedPath[0].endRenderPoint;
    var lastPoint = transformedPath[pointCount - 1].endRenderPoint;
  ...
  Color get renderColor {
    final isBackFaceColor = isFacingBack;
